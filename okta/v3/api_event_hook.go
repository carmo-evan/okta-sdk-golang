...
type EventHookApi interface {
	...
	*/
	...
	/*
	UpdateEventHook Replace an Event Hook

	Success

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param eventHookId
	@return ApiUpdateEventHookRequest
	*/
	UpdateEventHook(ctx context.Context, eventHookId string) ApiUpdateEventHookRequest

	// UpdateEventHookExecute executes the request
	//  @return EventHook
	UpdateEventHookExecute(r ApiUpdateEventHookRequest) (*EventHook, *APIResponse, error)
...
type ApiUpdateEventHookRequest struct {
	ctx context.Context
	ApiService EventHookApi
	eventHookId string
	eventHook *EventHook
...
func (r ApiUpdateEventHookRequest) EventHook(eventHook EventHook) ApiUpdateEventHookRequest {
	r.eventHook = &eventHook
	return r
}

func (r ApiUpdateEventHookRequest) Execute() (*EventHook, *APIResponse, error) {
	return r.ApiService.UpdateEventHookExecute(r)
}
...
Success
 ...
 @return ApiUpdateEventHookRequest
*/
func (a *EventHookApiService) UpdateEventHook(ctx context.Context, eventHookId string) ApiUpdateEventHookRequest {
	return ApiUpdateEventHookRequest{
		ApiService: a,
		ctx: ctx,
		eventHookId: eventHookId,
...
// Execute executes the request
//  @return EventHook
func (a *EventHookApiService) UpdateEventHookExecute(r ApiUpdateEventHookRequest) (*EventHook, *APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventHookApiService.UpdateEventHook")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
