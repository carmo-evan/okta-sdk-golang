...
type ApplicationApi interface {
	...
	*/
	...
	/*
	CreateApplicationGroupAssignment Assign a Group
	...
	@param appId
	@param groupId
	@return ApiCreateApplicationGroupAssignmentRequest
	*/
	CreateApplicationGroupAssignment(ctx context.Context, appId string, groupId string) ApiCreateApplicationGroupAssignmentRequest

	// CreateApplicationGroupAssignmentExecute executes the request
	//  @return ApplicationGroupAssignment
	CreateApplicationGroupAssignmentExecute(r ApiCreateApplicationGroupAssignmentRequest) (*ApplicationGroupAssignment, *APIResponse, error)
	...
	*/
	...
	/*
	DeleteApplicationGroupAssignment Unassign a Group
	...
	@param appId
	@param groupId
	@return ApiDeleteApplicationGroupAssignmentRequest
	*/
	DeleteApplicationGroupAssignment(ctx context.Context, appId string, groupId string) ApiDeleteApplicationGroupAssignmentRequest

	// DeleteApplicationGroupAssignmentExecute executes the request
	DeleteApplicationGroupAssignmentExecute(r ApiDeleteApplicationGroupAssignmentRequest) (*APIResponse, error)

	/*
	DeleteApplicationUser Unassign a User
	...
	@param appId
	@param userId
	@return ApiDeleteApplicationUserRequest
	*/
	DeleteApplicationUser(ctx context.Context, appId string, userId string) ApiDeleteApplicationUserRequest

	// DeleteApplicationUserExecute executes the request
	DeleteApplicationUserExecute(r ApiDeleteApplicationUserRequest) (*APIResponse, error)
	...
	*/
	...
	/*
	SetDefaultProvisioningConnectionForApplication Update the default Provisioning Connection

	Set default Provisioning Connection for application

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param appId
	@return ApiSetDefaultProvisioningConnectionForApplicationRequest
	*/
	SetDefaultProvisioningConnectionForApplication(ctx context.Context, appId string) ApiSetDefaultProvisioningConnectionForApplicationRequest

	// SetDefaultProvisioningConnectionForApplicationExecute executes the request
	//  @return ProvisioningConnection
	SetDefaultProvisioningConnectionForApplicationExecute(r ApiSetDefaultProvisioningConnectionForApplicationRequest) (*ProvisioningConnection, *APIResponse, error)

	/*
	UpdateApplication Replace an Application
	...
	*/
	UpdateApplication(ctx context.Context, appId string) ApiUpdateApplicationRequest

	// UpdateApplicationExecute executes the request
	//  @return ListApplications200ResponseInner
	UpdateApplicationExecute(r ApiUpdateApplicationRequest) (*ListApplications200ResponseInner, *APIResponse, error)
...
type ApiCreateApplicationGroupAssignmentRequest struct {
	ctx context.Context
	ApiService ApplicationApi
	appId string
	groupId string
...
func (r ApiCreateApplicationGroupAssignmentRequest) ApplicationGroupAssignment(applicationGroupAssignment ApplicationGroupAssignment) ApiCreateApplicationGroupAssignmentRequest {
	r.applicationGroupAssignment = &applicationGroupAssignment
	return r
}

func (r ApiCreateApplicationGroupAssignmentRequest) Execute() (*ApplicationGroupAssignment, *APIResponse, error) {
	return r.ApiService.CreateApplicationGroupAssignmentExecute(r)
}
...
Assigns a group to an application
 ...
 @return ApiCreateApplicationGroupAssignmentRequest
*/
func (a *ApplicationApiService) CreateApplicationGroupAssignment(ctx context.Context, appId string, groupId string) ApiCreateApplicationGroupAssignmentRequest {
	return ApiCreateApplicationGroupAssignmentRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
// Execute executes the request
//  @return ApplicationGroupAssignment
func (a *ApplicationApiService) CreateApplicationGroupAssignmentExecute(r ApiCreateApplicationGroupAssignmentRequest) (*ApplicationGroupAssignment, *APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationApiService.CreateApplicationGroupAssignment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiDeleteApplicationGroupAssignmentRequest struct {
	ctx context.Context
	ApiService ApplicationApi
	appId string
	groupId string
...
func (r ApiDeleteApplicationGroupAssignmentRequest) Execute() (*APIResponse, error) {
	return r.ApiService.DeleteApplicationGroupAssignmentExecute(r)
}
...
Removes a group assignment from an application.
 ...
 @return ApiDeleteApplicationGroupAssignmentRequest
*/
func (a *ApplicationApiService) DeleteApplicationGroupAssignment(ctx context.Context, appId string, groupId string) ApiDeleteApplicationGroupAssignmentRequest {
	return ApiDeleteApplicationGroupAssignmentRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
// Execute executes the request
func (a *ApplicationApiService) DeleteApplicationGroupAssignmentExecute(r ApiDeleteApplicationGroupAssignmentRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationApiService.DeleteApplicationGroupAssignment")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiDeleteApplicationUserRequest struct {
	ctx context.Context
	ApiService ApplicationApi
	appId string
	userId string
...
func (r ApiDeleteApplicationUserRequest) SendEmail(sendEmail bool) ApiDeleteApplicationUserRequest {
	r.sendEmail = &sendEmail
	return r
}

func (r ApiDeleteApplicationUserRequest) Execute() (*APIResponse, error) {
	return r.ApiService.DeleteApplicationUserExecute(r)
}
...
Removes an assignment for a user from an application.
 ...
 @return ApiDeleteApplicationUserRequest
*/
func (a *ApplicationApiService) DeleteApplicationUser(ctx context.Context, appId string, userId string) ApiDeleteApplicationUserRequest {
	return ApiDeleteApplicationUserRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
// Execute executes the request
func (a *ApplicationApiService) DeleteApplicationUserExecute(r ApiDeleteApplicationUserRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationApiService.DeleteApplicationUser")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSetDefaultProvisioningConnectionForApplicationRequest struct {
	ctx context.Context
	ApiService ApplicationApi
	appId string
...
func (r ApiSetDefaultProvisioningConnectionForApplicationRequest) ProvisioningConnectionRequest(provisioningConnectionRequest ProvisioningConnectionRequest) ApiSetDefaultProvisioningConnectionForApplicationRequest {
	r.provisioningConnectionRequest = &provisioningConnectionRequest
	return r
}

func (r ApiSetDefaultProvisioningConnectionForApplicationRequest) Activate(activate bool) ApiSetDefaultProvisioningConnectionForApplicationRequest {
	r.activate = &activate
	return r
}

func (r ApiSetDefaultProvisioningConnectionForApplicationRequest) Execute() (*ProvisioningConnection, *APIResponse, error) {
	return r.ApiService.SetDefaultProvisioningConnectionForApplicationExecute(r)
}
...
Set default Provisioning Connection for application
 ...
 @return ApiSetDefaultProvisioningConnectionForApplicationRequest
*/
func (a *ApplicationApiService) SetDefaultProvisioningConnectionForApplication(ctx context.Context, appId string) ApiSetDefaultProvisioningConnectionForApplicationRequest {
	return ApiSetDefaultProvisioningConnectionForApplicationRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
// Execute executes the request
//  @return ProvisioningConnection
func (a *ApplicationApiService) SetDefaultProvisioningConnectionForApplicationExecute(r ApiSetDefaultProvisioningConnectionForApplicationRequest) (*ProvisioningConnection, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationApiService.SetDefaultProvisioningConnectionForApplication")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateApplicationRequest) Application(application ListApplications200ResponseInner) ApiUpdateApplicationRequest {
	r.application = &application
	return r
}

func (r ApiUpdateApplicationRequest) Execute() (*ListApplications200ResponseInner, *APIResponse, error) {
...
Updates an application in your organization.
 ...
 @return ApiUpdateApplicationRequest
*/
func (a *ApplicationApiService) UpdateApplication(ctx context.Context, appId string) ApiUpdateApplicationRequest {
	return ApiUpdateApplicationRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
// Execute executes the request
//  @return ListApplications200ResponseInner
func (a *ApplicationApiService) UpdateApplicationExecute(r ApiUpdateApplicationRequest) (*ListApplications200ResponseInner, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
