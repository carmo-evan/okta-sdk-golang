...
`func (o *Domain) GetCertificateSourceType() string`
...
`func (o *Domain) GetCertificateSourceTypeOk() (*string, bool)`
...
`func (o *Domain) SetCertificateSourceType(v string)`
...
`func (o *Domain) SetValidationStatus(v string)`
