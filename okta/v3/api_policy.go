...
type PolicyApi interface {
	...
	*/
	...
	//  @return ListPolicies200ResponseInner
	UpdatePolicyExecute(r ApiUpdatePolicyRequest) (*ListPolicies200ResponseInner, *APIResponse, error)

	/*
	UpdatePolicyRule Replace a Policy Rule
	...
	@param policyId
	@param ruleId
	@return ApiUpdatePolicyRuleRequest
	*/
	UpdatePolicyRule(ctx context.Context, policyId string, ruleId string) ApiUpdatePolicyRuleRequest

	// UpdatePolicyRuleExecute executes the request
	//  @return ListPolicyRules200ResponseInner
	UpdatePolicyRuleExecute(r ApiUpdatePolicyRuleRequest) (*ListPolicyRules200ResponseInner, *APIResponse, error)
}
...
func (r ApiUpdatePolicyRequest) Policy(policy ListPolicies200ResponseInner) ApiUpdatePolicyRequest {
	r.policy = &policy
	return r
}

func (r ApiUpdatePolicyRequest) Execute() (*ListPolicies200ResponseInner, *APIResponse, error) {
...
// Execute executes the request
//  @return ListPolicies200ResponseInner
func (a *PolicyApiService) UpdatePolicyExecute(r ApiUpdatePolicyRequest) (*ListPolicies200ResponseInner, *APIResponse, error) {
	var (
...
type ApiUpdatePolicyRuleRequest struct {
	ctx context.Context
	ApiService PolicyApi
	policyId string
	ruleId string
...
func (r ApiUpdatePolicyRuleRequest) PolicyRule(policyRule ListPolicyRules200ResponseInner) ApiUpdatePolicyRuleRequest {
	r.policyRule = &policyRule
	return r
}

func (r ApiUpdatePolicyRuleRequest) Execute() (*ListPolicyRules200ResponseInner, *APIResponse, error) {
	return r.ApiService.UpdatePolicyRuleExecute(r)
}
...
Updates a policy rule.
 ...
 @return ApiUpdatePolicyRuleRequest
*/
func (a *PolicyApiService) UpdatePolicyRule(ctx context.Context, policyId string, ruleId string) ApiUpdatePolicyRuleRequest {
	return ApiUpdatePolicyRuleRequest{
		ApiService: a,
		ctx: ctx,
		policyId: policyId,
...
// Execute executes the request
//  @return ListPolicyRules200ResponseInner
func (a *PolicyApiService) UpdatePolicyRuleExecute(r ApiUpdatePolicyRuleRequest) (*ListPolicyRules200ResponseInner, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PolicyApiService.UpdatePolicyRule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
