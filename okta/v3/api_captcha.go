...
type CAPTCHAApi interface {
	...
	*/
	...
	/*
	PartialUpdateCaptchaInstance Update a CAPTCHA instance

	Partially update a CAPTCHA instance by `captchaId`.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param captchaId id of the CAPTCHA
	@return ApiPartialUpdateCaptchaInstanceRequest
	*/
	PartialUpdateCaptchaInstance(ctx context.Context, captchaId string) ApiPartialUpdateCaptchaInstanceRequest

	// PartialUpdateCaptchaInstanceExecute executes the request
	//  @return CAPTCHAInstance
	PartialUpdateCaptchaInstanceExecute(r ApiPartialUpdateCaptchaInstanceRequest) (*CAPTCHAInstance, *APIResponse, error)

	/*
	UpdateCaptchaInstance Replace a CAPTCHA instance
...
type ApiPartialUpdateCaptchaInstanceRequest struct {
	ctx context.Context
	ApiService CAPTCHAApi
	captchaId string
	instance *CAPTCHAInstance
...
func (r ApiPartialUpdateCaptchaInstanceRequest) Instance(instance CAPTCHAInstance) ApiPartialUpdateCaptchaInstanceRequest {
	r.instance = &instance
	return r
}

func (r ApiPartialUpdateCaptchaInstanceRequest) Execute() (*CAPTCHAInstance, *APIResponse, error) {
	return r.ApiService.PartialUpdateCaptchaInstanceExecute(r)
}
...
Partially update a CAPTCHA instance by `captchaId`.
 ...
 @return ApiPartialUpdateCaptchaInstanceRequest
*/
func (a *CAPTCHAApiService) PartialUpdateCaptchaInstance(ctx context.Context, captchaId string) ApiPartialUpdateCaptchaInstanceRequest {
	return ApiPartialUpdateCaptchaInstanceRequest{
		ApiService: a,
		ctx: ctx,
		captchaId: captchaId,
...
// Execute executes the request
//  @return CAPTCHAInstance
func (a *CAPTCHAApiService) PartialUpdateCaptchaInstanceExecute(r ApiPartialUpdateCaptchaInstanceRequest) (*CAPTCHAInstance, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CAPTCHAApiService.PartialUpdateCaptchaInstance")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
