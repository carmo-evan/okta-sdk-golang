...
type DeviceAssuranceApi interface {
	...
	*/
	...
	/*
	UpdateDeviceAssurancePolicy Replace a Device Assurance Policy

	Updates a Device Assurance Policy by `deviceAssuranceId`.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param deviceAssuranceId Id of the Device Assurance Policy
	@return ApiUpdateDeviceAssurancePolicyRequest
	*/
	UpdateDeviceAssurancePolicy(ctx context.Context, deviceAssuranceId string) ApiUpdateDeviceAssurancePolicyRequest

	// UpdateDeviceAssurancePolicyExecute executes the request
	//  @return DeviceAssurance
	UpdateDeviceAssurancePolicyExecute(r ApiUpdateDeviceAssurancePolicyRequest) (*DeviceAssurance, *APIResponse, error)
}
...
type ApiUpdateDeviceAssurancePolicyRequest struct {
	ctx context.Context
	ApiService DeviceAssuranceApi
	deviceAssuranceId string
	deviceAssurance *DeviceAssurance
...
func (r ApiUpdateDeviceAssurancePolicyRequest) DeviceAssurance(deviceAssurance DeviceAssurance) ApiUpdateDeviceAssurancePolicyRequest {
	r.deviceAssurance = &deviceAssurance
	return r
}

func (r ApiUpdateDeviceAssurancePolicyRequest) Execute() (*DeviceAssurance, *APIResponse, error) {
	return r.ApiService.UpdateDeviceAssurancePolicyExecute(r)
}
...
Updates a Device Assurance Policy by `deviceAssuranceId`.
 ...
 @return ApiUpdateDeviceAssurancePolicyRequest
*/
func (a *DeviceAssuranceApiService) UpdateDeviceAssurancePolicy(ctx context.Context, deviceAssuranceId string) ApiUpdateDeviceAssurancePolicyRequest {
	return ApiUpdateDeviceAssurancePolicyRequest{
		ApiService: a,
		ctx: ctx,
		deviceAssuranceId: deviceAssuranceId,
...
// Execute executes the request
//  @return DeviceAssurance
func (a *DeviceAssuranceApiService) UpdateDeviceAssurancePolicyExecute(r ApiUpdateDeviceAssurancePolicyRequest) (*DeviceAssurance, *APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceAssuranceApiService.UpdateDeviceAssurancePolicy")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
