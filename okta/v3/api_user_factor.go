...
type UserFactorApi interface {
	...
	*/
	DeleteFactor(ctx context.Context, userId string, factorId string) ApiDeleteFactorRequest

	// DeleteFactorExecute executes the request
	DeleteFactorExecute(r ApiDeleteFactorRequest) (*APIResponse, error)
...
func (r ApiDeleteFactorRequest) RemoveEnrollmentRecovery(removeEnrollmentRecovery bool) ApiDeleteFactorRequest {
	r.removeEnrollmentRecovery = &removeEnrollmentRecovery
	return r
}

func (r ApiDeleteFactorRequest) Execute() (*APIResponse, error) {
...
Unenrolls an existing factor for the specified user, allowing the user to enroll a new factor.
 ...
 @return ApiDeleteFactorRequest
*/
func (a *UserFactorApiService) DeleteFactor(ctx context.Context, userId string, factorId string) ApiDeleteFactorRequest {
	return ApiDeleteFactorRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
func (a *UserFactorApiService) DeleteFactorExecute(r ApiDeleteFactorRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserFactorApiService.DeleteFactor")
	if err != nil {
