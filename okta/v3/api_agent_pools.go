...
type AgentPoolsApi interface {
	...
	*/
	...
	/*
	GetAgentPools List all Agent Pools
	...
	*/
	GetAgentPools(ctx context.Context) ApiGetAgentPoolsRequest

	// GetAgentPoolsExecute executes the request
	//  @return []AgentPool
	GetAgentPoolsExecute(r ApiGetAgentPoolsRequest) ([]AgentPool, *APIResponse, error)
	...
	*/
	...
	/*
	GetAgentPoolsUpdates List all Agent Pool updates

	Gets List of Agent pool updates

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param poolId Id of the agent pool for which the settings will apply
	@return ApiGetAgentPoolsUpdatesRequest
	*/
	GetAgentPoolsUpdates(ctx context.Context, poolId string) ApiGetAgentPoolsUpdatesRequest

	// GetAgentPoolsUpdatesExecute executes the request
	//  @return []AgentPoolUpdate
	GetAgentPoolsUpdatesExecute(r ApiGetAgentPoolsUpdatesRequest) ([]AgentPoolUpdate, *APIResponse, error)
	...
	*/
	...
	/*
	SetAgentPoolsUpdateSettings Update an Agent pool update settings

	Updates Agent pool update settings

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param poolId Id of the agent pool for which the settings will apply
	@return ApiSetAgentPoolsUpdateSettingsRequest
	*/
	SetAgentPoolsUpdateSettings(ctx context.Context, poolId string) ApiSetAgentPoolsUpdateSettingsRequest

	// SetAgentPoolsUpdateSettingsExecute executes the request
	//  @return AgentPoolUpdateSetting
	SetAgentPoolsUpdateSettingsExecute(r ApiSetAgentPoolsUpdateSettingsRequest) (*AgentPoolUpdateSetting, *APIResponse, error)
...
func (r ApiGetAgentPoolsRequest) LimitPerPoolType(limitPerPoolType int32) ApiGetAgentPoolsRequest {
	r.limitPerPoolType = &limitPerPoolType
	return r
}

// Agent type to search for
func (r ApiGetAgentPoolsRequest) PoolType(poolType string) ApiGetAgentPoolsRequest {
	r.poolType = &poolType
	return r
}
...
func (r ApiGetAgentPoolsRequest) After(after string) ApiGetAgentPoolsRequest {
	r.after = &after
	return r
}

func (r ApiGetAgentPoolsRequest) Execute() ([]AgentPool, *APIResponse, error) {
...
Fetches AgentPools based on request parameters for a given org
 ...
 @return ApiGetAgentPoolsRequest
*/
func (a *AgentPoolsApiService) GetAgentPools(ctx context.Context) ApiGetAgentPoolsRequest {
	return ApiGetAgentPoolsRequest{
		ApiService: a,
		ctx: ctx,
		retryCount: 0,
...
// Execute executes the request
//  @return []AgentPool
func (a *AgentPoolsApiService) GetAgentPoolsExecute(r ApiGetAgentPoolsRequest) ([]AgentPool, *APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgentPoolsApiService.GetAgentPools")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetAgentPoolsUpdatesRequest struct {
	ctx context.Context
	ApiService AgentPoolsApi
	poolId string
	scheduled *bool
...
func (r ApiGetAgentPoolsUpdatesRequest) Scheduled(scheduled bool) ApiGetAgentPoolsUpdatesRequest {
	r.scheduled = &scheduled
	return r
}

func (r ApiGetAgentPoolsUpdatesRequest) Execute() ([]AgentPoolUpdate, *APIResponse, error) {
	return r.ApiService.GetAgentPoolsUpdatesExecute(r)
}
...
Gets List of Agent pool updates
 ...
 @return ApiGetAgentPoolsUpdatesRequest
*/
func (a *AgentPoolsApiService) GetAgentPoolsUpdates(ctx context.Context, poolId string) ApiGetAgentPoolsUpdatesRequest {
	return ApiGetAgentPoolsUpdatesRequest{
		ApiService: a,
		ctx: ctx,
		poolId: poolId,
...
// Execute executes the request
//  @return []AgentPoolUpdate
func (a *AgentPoolsApiService) GetAgentPoolsUpdatesExecute(r ApiGetAgentPoolsUpdatesRequest) ([]AgentPoolUpdate, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgentPoolsApiService.GetAgentPoolsUpdates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSetAgentPoolsUpdateSettingsRequest struct {
	ctx context.Context
	ApiService AgentPoolsApi
	poolId string
...
func (r ApiSetAgentPoolsUpdateSettingsRequest) AgentPoolUpdateSetting(agentPoolUpdateSetting AgentPoolUpdateSetting) ApiSetAgentPoolsUpdateSettingsRequest {
	r.agentPoolUpdateSetting = &agentPoolUpdateSetting
	return r
}

func (r ApiSetAgentPoolsUpdateSettingsRequest) Execute() (*AgentPoolUpdateSetting, *APIResponse, error) {
	return r.ApiService.SetAgentPoolsUpdateSettingsExecute(r)
}
...
Updates Agent pool update settings
 ...
 @return ApiSetAgentPoolsUpdateSettingsRequest
*/
func (a *AgentPoolsApiService) SetAgentPoolsUpdateSettings(ctx context.Context, poolId string) ApiSetAgentPoolsUpdateSettingsRequest {
	return ApiSetAgentPoolsUpdateSettingsRequest{
		ApiService: a,
		ctx: ctx,
		poolId: poolId,
...
// Execute executes the request
//  @return AgentPoolUpdateSetting
func (a *AgentPoolsApiService) SetAgentPoolsUpdateSettingsExecute(r ApiSetAgentPoolsUpdateSettingsRequest) (*AgentPoolUpdateSetting, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgentPoolsApiService.SetAgentPoolsUpdateSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
