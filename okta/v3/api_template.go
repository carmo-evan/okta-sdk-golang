...
type TemplateApi interface {
	...
	*/
	...
	/*
	PartialUpdateSmsTemplate Update an SMS Template

	Updates only some of the SMS template properties:

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param templateId
	@return ApiPartialUpdateSmsTemplateRequest
	*/
	PartialUpdateSmsTemplate(ctx context.Context, templateId string) ApiPartialUpdateSmsTemplateRequest

	// PartialUpdateSmsTemplateExecute executes the request
	//  @return SmsTemplate
	PartialUpdateSmsTemplateExecute(r ApiPartialUpdateSmsTemplateRequest) (*SmsTemplate, *APIResponse, error)

	/*
	UpdateSmsTemplate Replace an SMS Template
...
type ApiPartialUpdateSmsTemplateRequest struct {
	ctx context.Context
	ApiService TemplateApi
	templateId string
	smsTemplate *SmsTemplate
...
func (r ApiPartialUpdateSmsTemplateRequest) SmsTemplate(smsTemplate SmsTemplate) ApiPartialUpdateSmsTemplateRequest {
	r.smsTemplate = &smsTemplate
	return r
}

func (r ApiPartialUpdateSmsTemplateRequest) Execute() (*SmsTemplate, *APIResponse, error) {
	return r.ApiService.PartialUpdateSmsTemplateExecute(r)
}
...
Updates only some of the SMS template properties:
 ...
 @return ApiPartialUpdateSmsTemplateRequest
*/
func (a *TemplateApiService) PartialUpdateSmsTemplate(ctx context.Context, templateId string) ApiPartialUpdateSmsTemplateRequest {
	return ApiPartialUpdateSmsTemplateRequest{
		ApiService: a,
		ctx: ctx,
		templateId: templateId,
...
// Execute executes the request
//  @return SmsTemplate
func (a *TemplateApiService) PartialUpdateSmsTemplateExecute(r ApiPartialUpdateSmsTemplateRequest) (*SmsTemplate, *APIResponse, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemplateApiService.PartialUpdateSmsTemplate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
