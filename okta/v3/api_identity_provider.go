...
type IdentityProviderApi interface {
	...
	*/
	...
	/*
	UpdateIdentityProvider Replace an Identity Provider
	...
	*/
	UpdateIdentityProvider(ctx context.Context, idpId string) ApiUpdateIdentityProviderRequest

	// UpdateIdentityProviderExecute executes the request
	//  @return IdentityProvider
	UpdateIdentityProviderExecute(r ApiUpdateIdentityProviderRequest) (*IdentityProvider, *APIResponse, error)
}
...
func (r ApiUpdateIdentityProviderRequest) Execute() (*IdentityProvider, *APIResponse, error) {
...
Updates the configuration for an IdP.
 ...
 @return ApiUpdateIdentityProviderRequest
*/
func (a *IdentityProviderApiService) UpdateIdentityProvider(ctx context.Context, idpId string) ApiUpdateIdentityProviderRequest {
	return ApiUpdateIdentityProviderRequest{
		ApiService: a,
		ctx: ctx,
		idpId: idpId,
...
// Execute executes the request
//  @return IdentityProvider
func (a *IdentityProviderApiService) UpdateIdentityProviderExecute(r ApiUpdateIdentityProviderRequest) (*IdentityProvider, *APIResponse, error) {
	var (
