...
type PrincipalRateLimitApi interface {
	...
	*/
	...
	/*
	UpdatePrincipalRateLimitEntity Replace a Principal Rate Limit

	Update a  Principal Rate Limit entity by `principalRateLimitId`.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param principalRateLimitId id of the Principal Rate Limit
	@return ApiUpdatePrincipalRateLimitEntityRequest
	*/
	UpdatePrincipalRateLimitEntity(ctx context.Context, principalRateLimitId string) ApiUpdatePrincipalRateLimitEntityRequest

	// UpdatePrincipalRateLimitEntityExecute executes the request
	//  @return PrincipalRateLimitEntity
	UpdatePrincipalRateLimitEntityExecute(r ApiUpdatePrincipalRateLimitEntityRequest) (*PrincipalRateLimitEntity, *APIResponse, error)
}
...
type ApiUpdatePrincipalRateLimitEntityRequest struct {
	ctx context.Context
	ApiService PrincipalRateLimitApi
	principalRateLimitId string
	entity *PrincipalRateLimitEntity
...
func (r ApiUpdatePrincipalRateLimitEntityRequest) Entity(entity PrincipalRateLimitEntity) ApiUpdatePrincipalRateLimitEntityRequest {
	r.entity = &entity
	return r
}

func (r ApiUpdatePrincipalRateLimitEntityRequest) Execute() (*PrincipalRateLimitEntity, *APIResponse, error) {
	return r.ApiService.UpdatePrincipalRateLimitEntityExecute(r)
}
...
Update a  Principal Rate Limit entity by `principalRateLimitId`.
 ...
 @return ApiUpdatePrincipalRateLimitEntityRequest
*/
func (a *PrincipalRateLimitApiService) UpdatePrincipalRateLimitEntity(ctx context.Context, principalRateLimitId string) ApiUpdatePrincipalRateLimitEntityRequest {
	return ApiUpdatePrincipalRateLimitEntityRequest{
		ApiService: a,
		ctx: ctx,
		principalRateLimitId: principalRateLimitId,
...
// Execute executes the request
//  @return PrincipalRateLimitEntity
func (a *PrincipalRateLimitApiService) UpdatePrincipalRateLimitEntityExecute(r ApiUpdatePrincipalRateLimitEntityRequest) (*PrincipalRateLimitEntity, *APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrincipalRateLimitApiService.UpdatePrincipalRateLimitEntity")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
