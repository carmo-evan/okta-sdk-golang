...
type DomainApi interface {
	...
	/*
	CreateCertificate Replace the Certificate
	...
	*/
	CreateCertificate(ctx context.Context, domainId string) ApiCreateCertificateRequest

	// CreateCertificateExecute executes the request
	CreateCertificateExecute(r ApiCreateCertificateRequest) (*APIResponse, error)
...
func (r ApiCreateCertificateRequest) Certificate(certificate DomainCertificate) ApiCreateCertificateRequest {
	r.certificate = &certificate
	return r
}

func (r ApiCreateCertificateRequest) Execute() (*APIResponse, error) {
...
Creates the Certificate for the Domain.
 ...
 @return ApiCreateCertificateRequest
*/
func (a *DomainApiService) CreateCertificate(ctx context.Context, domainId string) ApiCreateCertificateRequest {
	return ApiCreateCertificateRequest{
		ApiService: a,
		ctx: ctx,
		domainId: domainId,
...
func (a *DomainApiService) CreateCertificateExecute(r ApiCreateCertificateRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainApiService.CreateCertificate")
	if err != nil {
